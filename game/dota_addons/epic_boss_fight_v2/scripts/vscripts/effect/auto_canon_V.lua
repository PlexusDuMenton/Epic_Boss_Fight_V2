if lua_hero_effect_auto_canon_V == nil then lua_hero_effect_auto_canon_V = class({}) end
function lua_hero_effect_auto_canon_V:OnCreated()
	if IsServer() then
		local hero = self:GetParent()
		Timers:CreateTimer(0.5, function()
			if hero:HasModifier("lua_hero_effect_auto_canon_V") == true then
...
function lua_hero_effect_auto_canon_V:IsHidden()
	return false
end


function lua_hero_effect_auto_canon_V:GetAttributes()
