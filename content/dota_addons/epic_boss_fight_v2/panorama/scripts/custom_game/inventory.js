...
function Open_Hero_Panel(){
	...
	function refresh_hero_stat(){
		...
		{	
			...
			var dmg = Number((stats.effect_bonus.damage+stats.equip_stats.damage + stats.skill_stats.str*1.5 +stats.hero_stats.str*1.5+ stats.equip_stats.str*1.5 + 2).toFixed(0));
			...
			H_as.style.position = "350px 290px 1px";
				...
				if (typeof inventory != 'undefined'){
					...
					if (typeof inventory.item_bar[i+1] != 'undefined')
					{
						...
						Panel.SetPanelEvent('onactivate', (function(){
							...
							exit.SetHasClass( "Main", true );
							var Menu = $.CreatePanel( "Panel", $("#Menu"), "menu_"+item_slot.toString() );
