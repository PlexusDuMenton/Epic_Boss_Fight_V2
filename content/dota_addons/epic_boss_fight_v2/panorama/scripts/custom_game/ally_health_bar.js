...
function Open_Hero_Panel(ID_hero){
	...
	function refresh_hero_stat(ID_hero,stats,hero_id){
		...
		{	
			...
			H_name.style.position = "350px 45px 1px";
			...
			H_Lvl.style.position = "350px 80px 1px";
			...
			H_SP.style.position = "350px 110px 1px";
			...
			var as = Entities.GetAttackSpeed( Players.GetPlayerHeroEntityIndex( ID_hero ) ) + stats.hero_stats.attack_speed + stats.skill_stats.attack_speed + stats.skill_stats.agi*0.33 +stats.equip_stats.attack_speed + stats.hero_stats.agi*0.33
			var attack_speed = ((100 + as) * 0.01) / (Entities.GetBaseAttackTime( Players.GetPlayerHeroEntityIndex( ID_hero ) ))
			...
			var hp =Entities.GetMaxHealth(Players.GetPlayerHeroEntityIndex( ID_hero ))
			...
			var mp =Entities.GetMaxMana(Players.GetPlayerHeroEntityIndex( ID_hero ))
			...
			var range = stats.equip_stats.range + stats.skill_stats.range + Entities.GetAttackRange( Players.GetPlayerHeroEntityIndex( ID_hero ) )
